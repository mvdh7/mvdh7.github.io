...
{% include elements/figure.html image="https://imgs.xkcd.com/comics/python.png" caption="As with many things in science and indeed life, there's an xkcd for it." %}
